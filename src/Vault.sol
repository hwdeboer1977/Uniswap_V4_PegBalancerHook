...
contract Vault is ERC20, ERC4626, Ownable, Pausable, ReentrancyGuard {
    ...
    /// @param _asset  Address of the asses WBTC, USDC underlying (... decimals).
    /// @param _owner Initial owner (admin).
    constructor(address _asset, address _owner, uint256 _initialRedemptionPeriod)
        ERC20("yToken Vault Share", "yToken")
